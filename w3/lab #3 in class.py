...
print(f"\t\tTo replace {desktop_count} desktops that were bought before 2016 it will cost ${desktop_money}")
print(f"\t\tTo replace {laptop_count} laptops that were bought before 2016 it will cost ${laptop_money}")
