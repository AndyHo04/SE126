...
#----------------Main Program---------------
#create empty id lists to hold data in text file
id_stud = []
lname = []
fname = []
class1 = []
...
seq_count = 0
#allows review of each value in list(sequence)
...
print(f"Searching Complete. Search Loop ran {seq_count} iterations")
if found[0] != "":
...
max = len(lname) - 1#last position of the list to besearched (ascending)
...
print(f"Searching Complete. Binary Loop ran {bin_count} iterations")
if search_name == lname[mid]:
